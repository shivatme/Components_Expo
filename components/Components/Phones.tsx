...
import { path, phones } from "./phonePaths";
...
import { SEGMENT_WIDTH } from "./Slider";
...
export default () => {
  ...
  //   slider.value,
  //   inputRange,
  //   path.map((phone) => phone.screen.x)
  // );
  // const y = interpolate(
  //   slider.value,
  //   inputRange,
  //   path.map((phone) => phone.screen.y)
  // );
  // const width = interpolate(
  //   slider.value,
  //   inputRange,
  //   path.map((phone) => phone.screen.width)
  // );
  // const height = interpolate(
  //   slider.value,
  //   inputRange,
  //   path.map((phone) => phone.screen.height)
  // );
  const mouths = [
  ...
  const mouthColor = interpolateColor(slider.value, inputRange, [
    "#664300",
    "#664300",
    "#DE2A42",
  ]);
      ...
      >
        <Canvas style={{ flex: 1, width: 250, height: 250 }}>
          <Group>
            ...
            <SkiaPath path={d1} color={"#664300"} />
            <SkiaPath path={d2} color={eyeColor} />
            <SkiaPath path={d3} color={eyeColor} />
          </Group>
        </Canvas>
      </View>
      <View
